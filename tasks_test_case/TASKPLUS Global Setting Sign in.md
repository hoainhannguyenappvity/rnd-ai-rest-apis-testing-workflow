...
| TC-013 | Security  | Injection attempt in value                               | **Method:** POST<br>**Body:** `{"setting":{"key":"InvitationCodeExpireMinutes","value":"10;DROP TABLE"}}`                             | 400             |
| TC-014 | Negative  | Invalid value type InvitationCodeVerifyLimit             | **Method:** POST<br>**Body:** `{"setting":{"key":"InvitationCodeVerifyLimit","value":"abc"}}`                                         | 400             |
| TC-015 | Auth      | Missing Authorization header                             | **Method:** POST<br>**Headers:** Authorization=None<br>**Body:** `{"setting":{"key":"InvitationCodeExpireMinutes","value":"10"}}`     | 401             |
| TC-016 | Auth      | Invalid authorization token                              | **Method:** POST<br>**Headers:** Authorization=InvalidToken<br>Body: `{"setting":{"key":"InvitationCodeExpireMinutes","value":"10"}}` | 401             |
| TC-017 | Negative  | Invalid value type InvitationCodeVerifyRetryDelaySeconds | **Method:** POST<br>**Body:** `{"setting":{"key":"InvitationCodeVerifyRetryDelaySeconds","value":"abc"}}`                             | 400             |
| TC-018 | Stability | Repeat valid request multiple times                      | **Method:** POST<br>**Body:** `{"setting":{"key":"InvitationCodeExpireMinutes","value":"10"}}`                                        | 200/204         |
