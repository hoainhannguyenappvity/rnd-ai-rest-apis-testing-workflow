...
| TC-002 | Positive | Filter active file tags            | **Method:** GET<br>**Params:** `$filter=active ne false and tagType eq 'file'` | 200; only active file tags     |
...
| TC-007 | Negative | Invalid filter syntax              | **Method:** GET<br>**Params:** `$filter=active !== false`                      | 400; validation error          |
| TC-008 | Security | Injection payload in filter        | **Method:** GET<br>**Params:** `$filter=tagType eq 'file' OR 1=1`              | 400/403; safely handled        |
...
| TC-003 | Negative | Missing required field `idsEntityAndCode`   | **Method:** POST<br>**Body:**`{ "addEntityTagPara": { "idsTag":"1321", "entityType":"file" } }`                                                                       | 400             |
...
| TC-005 | Negative | Invalid format for `idsEntityAndCode`       | **Method:** POST<br>**Body:**`{ "addEntityTagPara": { "idsEntityAndCode":"18214-1", "idsTag":"1321", "entityType":"file" } }`                                         | 400             |
| TC-006 | Negative | Entity ID from other workspace/site         | **Method:** POST<br>**Body:**`{ "addEntityTagPara": { "idsEntityAndCode":"999999~1", "idsTag":"1321", "entityType":"file" } }`                                        | 400/403/404     |
| TC-007 | Negative | Tag ID from other workspace/site            | **Method:** POST<br>**Body:**`{ "addEntityTagPara": { "idsEntityAndCode":"18214~1", "idsTag":"1322", "entityType":"file" } }`                                         | 400/403/404     |
| TC-008 | Negative | Invalid Content-Type                        | **Method:** POST<br>**Headers:** Content-Type=text/plain<br>**Body:**`{ "addEntityTagPara": { "idsEntityAndCode":"18214~1", "idsTag":"1321", "entityType":"file" } }` | 415/405         |
...
| TC-003 | Negative | Missing required parameter `entityId`       | **Method:** GET<br>**URL:** `{{base_url}}/v2/web/odata/SEEntityTag/SE.GetEntityTag(entityCode=1,entityType='file')`                                                   | 400             |
| TC-004 | Negative | Missing required parameter `entityCode`     | **Method:** GET<br>**URL:** `{{base_url}}/v2/web/odata/SEEntityTag/SE.GetEntityTag(entityId=18214,entityType='file')`                                                 | 400             |
| TC-005 | Negative | Missing required parameter `entityType`     | **Method:** GET<br>**URL:** `{{base_url}}/v2/web/odata/SEEntityTag/SE.GetEntityTag(entityId=18214,entityCode=1)`                                                      | 400             |
| TC-006 | Negative | Invalid format for `entityId`               | **Method:** GET<br>**URL:** `{{base_url}}/v2/web/odata/SEEntityTag/SE.GetEntityTag(entityId='abc',entityCode=1,entityType='file')`                                    | 400             |
| TC-007 | Negative | Invalid value for `entityCode`              | **Method:** GET<br>**URL:** `{{base_url}}/v2/web/odata/SEEntityTag/SE.GetEntityTag(entityId=18214,entityCode='xyz',entityType='file')`                                | 400             |
